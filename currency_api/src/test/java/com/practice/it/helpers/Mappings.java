...
public final class Mappings {
    ...
    public static final String COUNTRY_OF_HUF = "country-of-huf.json";

    public static final String LATEST_RATES_OF_HUF = "latest-rates-of-huf.json";

    public static final String LOWEST_AND_HIGHEST_RATES_OF_HUF = "lowest-and-highest-rates-of-huf.json";
